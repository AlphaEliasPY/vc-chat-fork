# AlphaMusic (Telegram bot project)
...
from AlphaMusic.config import ARQ_API_KEY
from AlphaMusic.config import BOT_NAME as bn
from AlphaMusic.config import DURATION_LIMIT
from AlphaMusic.config import UPDATES_CHANNEL as updateschannel
from AlphaMusic.config import que
from AlphaMusic.function.admins import admins as a
from AlphaMusic.helpers.admins import get_administrators
from AlphaMusic.helpers.channelmusic import get_chat_id
from AlphaMusic.helpers.decorators import authorized_users_only
from AlphaMusic.helpers.filters import command, other_filters
from AlphaMusic.helpers.gets import get_file_name
from AlphaMusic.services.callsmusic import callsmusic
from AlphaMusic.services.callsmusic import client as USER
from AlphaMusic.services.converter.converter import convert
from AlphaMusic.services.downloaders import youtube
from AlphaMusic.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @AlphaMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
